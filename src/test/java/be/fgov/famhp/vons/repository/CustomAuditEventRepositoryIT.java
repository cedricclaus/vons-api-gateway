package be.fgov.famhp.vons.repository;

import be.fgov.famhp.vons.VonsApiGatewayApp;
import be.fgov.famhp.vons.config.Constants;
import be.fgov.famhp.vons.config.TestSecurityConfiguration;
import be.fgov.famhp.vons.config.audit.AuditEventConverter;
import be.fgov.famhp.vons.domain.PersistentAuditEvent;
...
import static be.fgov.famhp.vons.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
